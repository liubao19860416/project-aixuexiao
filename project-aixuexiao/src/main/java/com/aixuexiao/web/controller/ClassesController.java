...
public class ClassesController {
    ...
    public ModelAndView listStudent(String pagenum, Classes classes) {
        ...
        List<Classes> list = classesService.listClasses((num - 1) * pagesize,
                pagesize, classes);
    ...
    public ModelAndView classesnewsPage(int classesid) {
        ModelAndView mv = new ModelAndView();
        Classes cls = classesService.findClassesById(classesid);
        List<ClassesNews> cnlist = classesService
                .findClassesNewsByClassId(classesid);
    ...
    public ModelAndView addStudent(Student student) {
        ...
        if (stu == null) {
            ...
            mv.addObject("notice",
                    "已经存在编号为" + student.getId() + "的学生(" + stu.getName() + ")！");
        }
